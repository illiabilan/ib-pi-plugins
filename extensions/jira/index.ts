...
const schema = Type.Object({
  ...
  issue_key: Type.Optional(Type.String({ description: "Issue key, e.g. ADA-123. For show/update/link (source)/transition/comment/delete." })),
...
Backlog cleanup / de-duplication flow:
  ...
  3. For each confirmed duplicate: {"action":"link","issue_keys":["ADA-2","ADA-3"],"link_type":"duplicates","target_key":"ADA-1"} then {"action":"transition","issue_keys":["ADA-2","ADA-3"],"transition":"Done","resolution":"Duplicate","body":"Closing as duplicate of ADA-1"}.
...
Examples:
  ...
  {"action":"transition","issue_key":"ADA-123","transition":"Done","resolution":"Duplicate","body":"Duplicate of ADA-100"}
  {"action":"comment","issue_key":"ADA-123","body":"Superseded by ADA-100"}
